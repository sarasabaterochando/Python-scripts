## 🚀 Python utilities for automating data workflows. 

This repository includes scripts for secure SFTP file transfers, REST API integration, and document processing pipelines.
Overview

This repository contains a collection of Python scripts focused on three main areas:

* 📁 Secure SFTP connections for uploading and downloading files.

* 🔧 REST API integrations to retrieve or send data between systems.
